...
import { loginDoctor, registerDoctor } from "../api/auth";
    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="card p-8 w-full max-w-md">
        ...
        <p className="text-center text-gray-500 text-sm mb-6">
          {isRegister ? "Create your professional account" : "Access your patient dashboard"}
        </p>
        ...
        <form onSubmit={submit} className="flex flex-col gap-4">
          ...
          {isRegister && (
            <>
              ...
              <input name="specialization" placeholder="Specialization (e.g. Pediatrician)"
                className="input" value={form.specialization} onChange={handle} />
              <input name="licenseNumber" placeholder="Medical License Number" required
                className="input" value={form.licenseNumber} onChange={handle} />
            </>
          )}
        ...
        <p className="text-center text-sm text-gray-500 mt-5">
          {isRegister ? "Already registered? " : "New doctor? "}
